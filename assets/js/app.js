(function () {
    ...
    return [
      {
        ...
        items: [
          ...
          { label: "Conteúdo de aula", href: inOrganization ? "../conteudos.html" : "conteudos.html", icon: "AU", roles: ["administrador", "funcionarios", "professores"] },
  ...
  function getNavIcon(icon) {
    const paths = {
      ...
      AU: '<path d="M4 5h16v14H4z"/><path d="M8 9h8M8 13h5"/><path d="M12 19v3M8 22h8"/>',
  ...
  async function mountShell() {
    ...
    const mobilePrimaryIcons = session.role === "professores"
      ? new Set(["PA", "DR", "AU", "FR", "CO"])
      : new Set(["PA", "DR", "AT", "CM", "CO"]);
